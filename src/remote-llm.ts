...
export class RemoteLLM implements LLM {
  ...
  async tokenize(_text: string): Promise<readonly LlamaToken[]> {
    throw new Error("RemoteLLM does not support tokenization — use HybridLLM to route tokenization to a local backend");
  }

  async detokenize(_tokens: readonly LlamaToken[]): Promise<string> {
    throw new Error("RemoteLLM does not support detokenization — use HybridLLM to route detokenization to a local backend");
  }
