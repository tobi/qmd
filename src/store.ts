...
export async function generateEmbeddings(
  ...
  // Use the store's configured LLM (or the global singleton), wrapped in a
  // session. Remote embedders do not expose a tokenizer, so use the
  // character-space chunker for them instead of initializing local llama.
