...
class TestModelLoading:
    ...
    def test_base_model_exists(self):
        ...
        model_path = Path(__file__).parent.parent / "models" / "Qwen_Qwen3-1.7B" / "mlx"
        assert model_path.exists(), f"Base model not found at {model_path}"

    def test_adapter_exists(self):
        """Check if trained adapter exists."""
        adapter_path = Path(__file__).parent.parent / "adapters" / "qmd_query_expansion_1.7B_sft"
    ...
    def test_adapter_config_valid(self):
        ...
        config_path = Path(__file__).parent.parent / "adapters" / "qmd_query_expansion_1.7B_sft" / "adapter_config.json"
