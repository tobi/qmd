...
Run `qmd update && qmd embed` after adding or editing notes. To automate
this on a schedule, see [docs/auto-update.md](docs/auto-update.md) for
macOS (launchd) and Linux (cron) examples.
